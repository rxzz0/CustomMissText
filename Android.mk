...
# Creating prebuilt for dependency: beatsaber-hook - version: 3.3.5
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"CustomMissText"' -DVERSION='"0.1.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
